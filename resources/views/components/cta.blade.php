...
<section id="download" class="py-6 md:py-16 bg-white scroll-mt-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="zoom-in max-w-5xl mx-auto bg-linear-to-br from-gray-900 to-gray-800 rounded-2xl md:rounded-3xl lg:rounded-[3rem] p-8 md:p-12 text-center shadow-2xl">
            ...
            <div class="flex justify-center px-4">
                <a href="<?php echo e($androidUrl); ?>" target="_blank" class="inline-flex items-center justify-center w-full sm:w-auto bg-[#8F42DE] hover:bg-purple-800 text-white text-sm sm:text-base md:text-lg font-semibold px-6 sm:px-8 md:px-10 lg:px-12 py-3 sm:py-3.5 md:py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
